// Using from Pyrite64 0.5.0 /n64/examples/jam25/src/user/systems/fonts.cpp
/**
...
void P64::Fonts::init()
{
  texNumbers = (sprite_t*)AssetManager::getByIndex("fonts/numbers.ia8.sprite"_asset);
}

void P64::Fonts::destroy()
{

}

void P64::Fonts::useNumber()
{
  rdpq_sprite_upload(TILE0, texNumbers, nullptr);
  rdpq_mode_combiner(RDPQ_COMBINER_TEX_FLAT);
}

void P64::Fonts::printNumber(int x, int y, uint32_t num)
{
